...
// meja atas
const tableTop = new THREE.Mesh(new THREE.BoxGeometry(3, 0.2, 2), woodMaterial);
...
function createLeg(x, z) {
  const leg = new THREE.Mesh(new THREE.BoxGeometry(0.2, 2, 0.2), woodMaterial);
...
// dudukan
const seat = new THREE.Mesh(new THREE.BoxGeometry(1, 0.2, 1), chairMaterial);
